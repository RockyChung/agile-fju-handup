      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          <article className="rounded-2xl border border-slate-100 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-500">單筆建立學生與整批匯入學生資料，可選擇加入課程。</p>
            <button
              type="button"
          ...
          <article className="rounded-2xl border border-slate-100 bg-white p-6">
            <h2 className="text-xl font-black text-slate-800">學生查詢</h2>
            <p className="mt-2 text-sm text-slate-500">依學號、姓名與課程查詢學生名單與組別資訊。</p>
            <button
              type="button"
              onClick={() => router.push("/teacher/dashboard/student-search")}
              className="mt-5 rounded-xl bg-indigo-600 px-4 py-2.5 font-bold text-white hover:bg-indigo-700"
            >
              進入學生查詢
            </button>
